...
# 保存映射关系到JSON文件
with open(r"D:\code\test\voice\game_qa\mapping.json", "w", encoding="utf-8") as f:
    json.dump(audio_mapping, f, ensure_ascii=False, indent=2)

print("映射关系生成完成！")
print(f"生成了 {len(audio_mapping)} 个映射项")
print("映射关系已保存到: D:\code\test\voice\game_qa\mapping.json")
